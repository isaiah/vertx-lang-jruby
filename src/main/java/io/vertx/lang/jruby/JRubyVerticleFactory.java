...
public class JRubyVerticleFactory implements VerticleFactory {
  ...
  public Verticle createVerticle(String verticleName, ClassLoader classLoader) throws Exception {
    init();
    return new JRubyVerticle(VerticleFactory.removePrefix(verticleName));
  }

  private final Map<String, AtomicInteger> deployCounts = new ConcurrentHashMap<>();

  public class JRubyVerticle extends AbstractVerticle {
    ...
    private JRubyVerticle(String verticleName) {
